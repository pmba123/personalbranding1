...
<?php wp_head(); ?>
<!-- This will inculde all important head-files from wordpress including functions.php. -->
</head>
...
<section id="aboutme" class="section descripton">
  <div class="container">
    <div class="col-md-10 col-md-offset-1 text-center">
      <?php
      if (is_active_sidebar('about_me')){
        dynamic_sidebar('about_me');
      }
       ?>
    </div>
...
<!-- JS FILES -->
<!-- Inserts all important files from Wordpress scripts including functions.php-->
<?php
wp_footer();
 ?>
</body>
